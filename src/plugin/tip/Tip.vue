<template>
  <transition :name="transitionFn" mode="out-in">
    <div class="toast_pane common_font typeStyle"
      ...
      <img v-if="showIcon && type=='success'" class="icon_style" src="./img/success.png" alt="">
      <img v-if="showIcon && type=='error'" class="icon_style" src="./img/error.png" alt="">
      <img v-if="showIcon && type=='loading'" class="icon_style" src="./img/loading_img.gif" alt="">
      <img v-if="showIcon && type=='wraning'" class="icon_style" src="./img/wraning.png" alt="">
      {{message}}
    </div>
  </transition>
</template>
